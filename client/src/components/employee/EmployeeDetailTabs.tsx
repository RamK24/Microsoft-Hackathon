...
import { LineChart, History, Calendar, MessageSquare } from 'lucide-react';
import { EmotionalToneTimeline } from '../dashboard/EmotionalToneTimeline';
import { RelationshipTrustStrength } from '../dashboard/RelationshipTrustStrength';
import { TriggerHeatmap } from '../dashboard/TriggerHeatmap';
...
const MOCK_RELATIONSHIP_METRICS = [
  { name: 'Trust', value: 75, color: '#4f46e5' },
  { name: 'Communication', value: 68, color: '#0ea5e9' },
  { name: 'Rapport', value: 82, color: '#8b5cf6' },
  { name: 'Support', value: 70, color: '#ec4899' },
];

const MOCK_TRIGGER_DATA = [
  { trigger: 'Loud Noise', calmness: 35, x: 1, y: 35, z: 15 },
  { trigger: 'Group Setting', calmness: 50, x: 2, y: 50, z: 10 },
  { trigger: 'Time Pressure', calmness: 25, x: 3, y: 25, z: 20 },
  { trigger: 'Unclear Instructions', calmness: 20, x: 4, y: 20, z: 25 },
  { trigger: 'Interruptions', calmness: 40, x: 5, y: 40, z: 15 },
  { trigger: 'New Tasks', calmness: 60, x: 6, y: 60, z: 10 },
];
      ...
      <Tabs defaultValue="progress" className="w-full">
        ...
        <TabsContent value="progress" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <RelationshipTrustStrength metrics={MOCK_RELATIONSHIP_METRICS} />
            <TriggerHeatmap triggerData={MOCK_TRIGGER_DATA} />
          </div>
        </TabsContent>
